...
<link href='/Public/css/add.css' rel='stylesheet' type='text/css'>
...
<div class="container">
				<div class="single">
					<div class="blog-to">		
						...
						<img class="img-responsive sin-on" src="/Public/images/sin1.jpg" alt="" />
							<div class="blog-top">
							<div class="blog-left">
								<b>23</b>
							</div>
			...
			<h3>3 Comments</h3>
				<div class="media">
				  <div class="media-left">
					<a href="#">
					  <img class="media-object" src="/Public/images/co.png" alt="">
					</a>
				  </div>
				  <div class="media-body">
					<h4 class="media-heading"><a href="#"><?php echo ($data["name"]); ?></a></h4>
		...
		<div class="single-bottom">
			...
			<!-- 用户添加评论的表单,添加了一个判断条件 -->
				<form method="post" action="/index.php/Home/Comments/insert" onsubmit="if(name.value=='用户名'){name.value='游客'} ;if(message.value=='内容'){message.value='';}">
						...
						<div class="col-md-4 comment">
						<input type="text" value="标题" name="subject" onfocus="this.value='';" onblur="if (this.value == '') {this.value ='标题';}">
						</div>
						<div class="clearfix"> </div>
						<textarea cols="77" rows="6" value=" " name="message" onfocus="this.value='';" onblur="if (this.value == '') {this.value = '内容';}">内容</textarea>
